...
public final class UseWarehouse {
    ...
    public static void main(final String[] args) {
         ...
         */
        final Product p1 = new ComparableProduct("Prodotto 6", 5);
        final Product p2 = new ComparableProduct("Prodottosos 2", 3);
        final Product p3 = new ComparableProduct("Prodotto 3", 9);
